...
export default function DataRoute() {
  ...
  if (operations.isPending) return <section className="page"><header className="page-header"><h1>数据与备份</h1></header><SkeletonPlaceholder style={{ width: '100%', height: '24rem' }} /></section>;
  if (operations.isError && !operations.data) return <section className="page"><header className="page-header"><h1>数据与备份</h1></header><InlineNotification hideCloseButton kind="error" title="无法获取数据与备份证据" subtitle={errorMessage(operations.error, '当前不能确认保留、备份或恢复状态。')} /></section>;
