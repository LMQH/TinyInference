...
func validManifest(compose, evidence string) []byte {
	...
	return []byte(`{"release":{"status":"verified"},"model":{"oci_digest":"sha256:` + strings64("d") + `"},"images":{"api":{"digest":"sha256:` + strings64("e") + `"},"web":{"digest":"sha256:` + strings64("f") + `"},"controller":{"digest":"sha256:` + strings64("1") + `"},"jobs":{"digest":"sha256:` + strings64("2") + `"}},"database":{"migration_version":6},"resolved_compose_config_sha256":"` + compose + `","privacy_gate":{"status":"passed","evidence_id":"privacy-1","exact_build_set":"` + builds + `","passed":true},"evidence":{"privacy":"` + evidence + `"},"unresolved_fields":[]}`)
}
