...
func(s *Server)Handler()http.Handler{
 ...
 return http.HandlerFunc(func(w http.ResponseWriter,r *http.Request){
  ...
  expected:="GET"
  if r.URL.Path=="/admin/v1/model/start"||r.URL.Path=="/admin/v1/model/stop"||strings.HasPrefix(r.URL.Path,"/admin/v1/queue/"){expected="POST"}
