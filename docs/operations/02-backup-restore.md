...
```text
var/backups/postgres/mini-inference-YYYYMMDDTHHMMSSZ-7.dump
var/backups/postgres/mini-inference-YYYYMMDDTHHMMSSZ-7.dump.sha256
```
...
```sh
python3 ops/restore-drill/select-backup.py mini-inference-YYYYMMDDTHHMMSSZ-7.dump
make restore-drill
make restore-record
